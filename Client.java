...
public class Client {
    ...
    private static final int MASTER_SERVER_PORT = 4999; // Port number of the master server

    public static void main(String[] args) {
        String defaultMasterAddress = DEFAULT_MASTER_ADDRESS; // Holds the default master server address
        ...
        try (Socket socket = new Socket(defaultMasterAddress, MASTER_SERVER_PORT); // Create socket connection to the master server
            ...
            System.out.println();
            System.out.println("Connected to Master Server. " + defaultMasterAddress + ":" + MASTER_SERVER_PORT);
            ...
            System.err.println("Could not connect to Master Server on " + defaultMasterAddress + ":" + MASTER_SERVER_PORT);
            e.printStackTrace();
        }
    }
}
